...
import { login, userPadraoRegister, addNewAdmin, getUserDetails, logoutPadrao, logoutAdmin, getAllUserP, addNewTecnico, getAllAdmin, getAllTecnicos } from "../controller/userController.js";
...
router.get("/userPAll", getAllUserP);
